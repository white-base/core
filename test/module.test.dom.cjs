...
describe("cjs", () => {
    ...
    describe("logic-core 모듈", () => {
        it("- 기본", async () => {
            const { PropertyCollection, ArrayCollection } = require('logic-core');   // dist/logic-core.node.cjs
    ...
    describe("dist/logic-core.browser.cjs 모듈", () => {
        it("- 기본", async () => {
            const { PropertyCollection, ArrayCollection } = require('../dist/logic-core.browser.cjs');
            const p = new PropertyCollection();
            const a = new ArrayCollection();
