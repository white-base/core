...
declare class MetaRegistry {
     ...
     * 등록소에서 메타 객체를 해제합니다.
     * 
     * @param metaOrGuid - 메타 객체 또는 GUID
     * @returns 성공 여부
     */
     ...
     * 
     * @param metaOrGuid - GUID 타입의 객체 또는 GUID
     * @returns 존재 여부
     */
     ...
     * 
     * @param guidObj - GUID 타입의 객체입니다.
     * @param sourceObj - 현재 객체를 설정하는 원본 객체입니다. 기본값은 `guidObj`입니다.
     */
    static createMetaObject(guidObj: object, sourceObj?: object): MetaObject;

    /**
     * GUID 객체에 대한 참조 객체를 생성합니다.
     * 
     * @param metaObj - 메타 객체입니다.
     ...
     * @param guidObj - GUID 타입의 객체입니다.
     * @param metaObj - GUID를 가지는 메타 객체입니다.
     ...
     * 
     * @param guidObj - 확인할 GUID 객체 또는 문자열입니다.
     * @param origin - 원본 객체입니다.
     * @returns 포함 여부를 반환합니다.
     */
    static hasGuidObject(guidObj: object | string, origin: object | object[]): boolean;

    /**
     * GUID 객체에 참조 타입 요소가 포함되어 있는지 확인합니다.
     * 참조 타입은 `$ref`와 `$ns`입니다.
     * 
     * @param guidObj - 확인할 GUID 객체입니다.
     * @returns 포함 여부를 반환합니다.
     */
     ...
     * 
     * @param guidObj - 조회할 GUID 값 또는 GUID 객체입니다.
     * @param origin - 원본 객체입니다.
     * @returns 조회된 메타 객체를 반환합니다.
     */
    static findSetObject(guidObj: object | string, origin: object): MetaObject;

    /**
     * GUID 객체의 참조 요소 값을 객체 참조로 변환합니다.
     * 변환 대상: `$ns`는 `[Object Object]`로 변환됩니다.
     * 
     * @param guidObj - 변환할 GUID 객체입니다.
     ...
     * @param namespace - 네임스페이스 이름입니다.
     * @param classOrFuncName - 대상 이름입니다. (클래스명 또는 함수명)
     */
