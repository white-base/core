            ...
            kor: { // 구분 코드 : 중복, 필수, 타입, 범위, 객체
                E: {        // Error
                    ...
                    L01: {  // 위치 기준 발생 에서
                        ...
                        101: {  // EL01101  
                            msg: '타입 매치검사 : $1의 세부 타입을 지정해야 합니다. extType: $2',
                        },
                        102: {  // EL01102  
                            msg: '타입 매치검사 : target 은 \'$1\' 타입이 아닙니다. tarType: $2',
                        },
                        103: {  // EL01103  
                            msg: '타입 매치검사 : 처리할 수 없는 타입니다. ',
                        },
                        111: {  // EL01111  
                            msg: '배열 매치검사 : target 은 array 타입이 아닙니다. tarType: $1',
                        },
                        112: {  // EL01112  
                            msg: '배열 매치검사 : array(_ANY_) 타입은 target array 의 요소가 하나 이상 가지고 있어야 합니다. target.length = $1',
                        },
                        113: {  // EL01113  
                            msg: '배열 매치검사 : array(_SEQ_) 타입의 길이보다 target array 의 길이가 작습니다. extType.length = $1, target.length = $2',
                        },
                        114: {  // EL01114  
                            msg: '배열 매치검사 : array(_SEQ_) [$1]번째 리터럴 타입이 target 값과 다릅니다. extType[$1] = $2, target[$1] = $3',
                        },
                        115: {  // EL01115  
                            msg: '배열 매치검사 : array(_SEQ_) [$1]번째 타입 검사가 실패하였습니다. extType[$1] = $2',
                        },
                        116: {  // EL01116  
                            msg: '배열 매치검사 : array(_REQ_) 타입은 target array 의 요소가 하나 이상 가지고 있어야 합니다. target.length = $1',
                        },
                        117: {  // EL01117   
                            msg: '배열 매치검사 : array 요소 검사가 실패하였습니다. extType: $1, tarType: $2',
                        },
                        121: {  // EL01121  
                            msg: '초이스 매치검사 : choice(_ANY_) 타입에 \'undefined\' 은 사용할 수 없습니다.',
                        },
                        122: {  // EL01122  
                            msg: '초이스 매치검사 : choice(_NON_) 타입에 \'undefined\' 만 가능합니다.',
                        },
                        123: {  // EL01123  
                            msg: '초이스 매치검사 : choice(_ERR_) 타입에 Errror 인스턴스 만 가능합니다.',
                        },
                        // 124: {  // EL01124  
                        ...
                        126: {  // EL01126  
                            ...
                            msg: '초이스 매치검사 : choice(_EUM_) 타입의 세부 타입은 리터럴만 가능합니다. extType[$1]: $2',
                        },
                        // 127: {  // EL01127  
                        //     msg: '타입매치검사 : $1 대상 $2 의 대한 원본에서 허용하는 타입이 없습니다.  ',
                        // },
                        128: {  // EL01128  
                            // msg: '타입매치검사 : [$1]는 [$2] 타입만 가능합니다.',
                            msg: '초이스 매치검사 : choice(_DEF_) 타입의 첫번째 세부 타입은 리터럴만 가능합니다. extType[0]: $1',
                        },
                        129: {  // EL01129  
                            // msg: '타입매치검사 : $1 타입 검사에 실패하였습니다. origin choice type: [$2], target type: [$3] ',
                            msg: '초이스 매치검사 : choice 세부 타입 검사가 실패하였습니다. extType: $1, tarType: $2',
                        },
                        131: {  // EL01131
                            msg: '클래스 매치검사 : class 타입을 union 타입으로 생성 후 검사에 실패하였습니다. (opt = 1)',
                        },
                        132: {  // EL01132  
                            // msg: '타입매치검사 : [$1]는 [$2]의 인스턴스가 아닙니다.',
                            msg: '클래스 매치검사 : target은 [$1]의 인스턴스가 아닙니다.',
                        },
                        133: {  // EL01133
                            msg: '클래스 매치검사 : target 이 class, object, union 타입이 아닙니다. tarType: $1',
                        },
                        141: {  // EL01141  ES024
                            // msg: '타입매치검사 : [$1]는 [$2]타입이 아닙니다. ',
                            msg: '유니언 매치검사 : target 은 union 타입이 아닙니다. tarType: $1',
                        },
                        142: {  // EL01142  ES027
                            // msg: '타입매치검사 : [$1]타입의 [$2]이 없습니다. ',
                            msg: '유니언 매치검사 : target[\'$1\'] 키가 존재하지 않습니다. extType[\'$1\'] = $2',
                        },
                        143: {  // EL01143  ES000
                            msg: '유니언 매치검사 : \'$1\' 타입 검사가 실패하였습니다.',
                        },
                        151: {  // EL01151  ES024
                            msg: '함수 매치검사 : [$1]는 [$2]타입이 아닙니다. ',
                        },
                        152: {  // EL01152  ES024
                            msg: '함수 매치검사 : [$1]는 [$2]과 다릅니다. ',
                        },
                        153: {  // EL01153  ES0740
                            msg: '함수 매치검사 :[$1]는 [$2]과 다릅니다. ',
                        },
                        154: {  // EL01154  ES079
                            msg: '함수 매치검사 : $1  $2 의 [$3] 객체가 없습니다. ',
                        },
                        155: {  // EL01155  ES0710
                            msg: '함수 매치검사 : $1 $2 객체규칙 "$3"과 맞지 않습니다. ',
                        },
                        156: {  // EL01156  ES0711
                            msg: '함수 매치검사 : $1 $2 타입검사에 실패하였습니다. $3 ',
                        },
                        157: {  // EL01157  ES0711
                            msg: '함수 매치검사 : $1 $2 타입검사에 실패하였습니다. $3 ',
                        },
