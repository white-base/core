            ...
            kor: { // 구분 코드 : 중복, 필수, 타입, 범위, 객체
                E: {        // Error
                    ...
                    L01: {  // 위치 기준 발생 에서
                        ...
                        203: {  // EL01203  ES0728
                            msg: '타입 허용 : $1 타입에는 $2 타입만 허용합니다. target kind = $3 ',
                        },
                        204: {  // EL01204  ES0727
                            msg: '타입 허용 : $1 타입에는 $2 타입을 거부합니다. target kind = $3 ',
                        },
                        205: {  // EL01205  ES0728
                            msg: '타입 허용 : $1 타입에는 $2 타입만 허용합니다. target kind = $3 ',
                        },
                        ...
                        209: {  // EL01209  ES0712
                            msg: '타입 허용 : $1 타입의 default 값이 다릅니다. [ $2 !== $3 ]',
                        },
                        '20A': {    // EL0120A  ES0713
                        ...
                        219: {  // EL01219  ES0738
                            msg: '배열 허용 : $1 대상 $2 의 대한 원본에서 허용하는 타입이 없습니다.  ',
                        },
                        221: {  // EL01221  ES0714
                        ...
                        223: {  // EL01223  ES0734
                            msg: '초이스 허용 : 대상 choice(val)에 내용이 없습니다. ',
                        },
                        224: {  // EL01224  ES021
                            msg: '초이스 허용 : [$1]는 [$2] 타입만 가능합니다.',
                        },
                        ...
                        231: {  // EL01231  ES0724
                            msg: '클래스 허용 : $1 타입의 생성 비교중 오류가 발생하였습니다. $2 ',
                        },
                        232: {  // EL01232  ES0724
                            msg: '클래스 허용 : $1 타입의 생성 비교중 오류가 발생하였습니다. $2 ',
                        },
                        233: {  // EL01233  ES0725
                            msg: '클래스 허용 : $1 타입의 생성 객체가 서로 다릅니다. ',
                        },
                        241: {  // EL01241  ES024
                        ...
                        251: {  // EL01251  ES0713
                            msg: '함수 허용 : 원본타입은 $1, 대상타입 $2 입니다. ',
                        },
                        252: {  // EL01252  ES0740
                            msg: '함수 허용 : [$1]는 [$2]과 다릅니다. ',
                        },
                        253: {  // EL01253  ES0740
                            msg: '함수 허용 : [$1]는 [$2]과 다릅니다. ',
                        },
                        254: {  // EL01254  ES079
                            msg: '함수 허용 : $1  $2 의 [$3] 객체가 없습니다. ',
                        },
                        255: {  // EL01255  ES0710
                            msg: '함수 허용 : $1 $2 객체규칙 "$3"과 맞지 않습니다. ',
                        },
                        256: {  // EL01256  ES0711
                            msg: '함수 허용 : $1 $2 타입검사에 실패하였습니다. $3 ',
                        },
                        257: {  // EL01257  ES0711
                            msg: '함수 허용 : $1 $2 타입검사에 실패하였습니다. $3 ',
                        },
                        258: {  // EL01258  ES024
                            msg: '함수 허용 : [$1]는 [$2]타입이 아닙니다. ',
                        },
